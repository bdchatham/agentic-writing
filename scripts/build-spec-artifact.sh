...
# heads. See styles/artifact/heading-hierarchy.css and docs/writing-modes.md.
#
...
# from prose, which is what docs/writing-modes.md alone asks a reader to do.
#
...
#      the artifact cannot drift from styles/artifact/heading-hierarchy.css.
